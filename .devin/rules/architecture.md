...
description: Route architecture, API-contract, native-module, data-model, and UI/design decisions to the canonical docs and ADRs instead of re-deriving or duplicating them.
---
