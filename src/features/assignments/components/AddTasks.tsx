...
const ways: { route: '/task-picker' | '/task-generate' | '/task-new'; icon: AppIconName; title: string; hint: string; short: string }[] = [
...
const styles = StyleSheet.create({
  chip: { alignItems: 'center', backgroundColor: colors.primarySoft, borderRadius: radius.pill, flex: 1, flexDirection: 'row', gap: 4, justifyContent: 'center', minHeight: touchTarget - 4, paddingHorizontal: spacing.xs },
  chipText: { color: colors.successSoft, fontFamily: fontFamilies.semibold, fontSize: 14 },
  row: { flexDirection: 'row', gap: spacing.xs },
  tile: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.divider, borderRadius: radius.lg, borderWidth: hairline, flex: 1, gap: 4, justifyContent: 'center', minHeight: 104, paddingHorizontal: 4, paddingVertical: spacing.sm },
